...
public class NonPlayableCharacter extends MapObject {
	...
	// player stuff
		...
		public NonPlayableCharacter(TileMap tm) {
			
			super(tm);
			
			width = 16; // Width by pixel
			height = 32; // height by pixel
			...
			facingRight = false; // Player will face right when the Level1State is first opened
